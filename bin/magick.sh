...
top_srcdir='/usr/local/bin/ImageMagick-6.7.6-3'
top_builddir='/usr/local/bin/ImageMagick-6.7.6-3'

MAGICK_CODER_MODULE_PATH='/usr/local/bin/ImageMagick-6.7.6-3/coders'
MAGICK_CONFIGURE_SRC_PATH='/usr/local/bin/ImageMagick-6.7.6-3/config'
MAGICK_CONFIGURE_BUILD_PATH='/usr/local/bin/ImageMagick-6.7.6-3/config'
MAGICK_FILTER_MODULE_PATH='/usr/local/bin/ImageMagick-6.7.6-3/filters'
DIRSEP=':'
